 ...
 */
export const createArtist = async (userId: string, artistData: IArtist): Promise<IArtist> => {
    try {
 ...
 */
export const updateArtist = async (artistId: string, updateData: Partial<Omit<IArtist, 'managingUserId'>>) => {
    try {
