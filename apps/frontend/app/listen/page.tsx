  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-2">
      ...
      <div className="flex flex-col items-center mt-8">
        <div className="bg-gray-200 h-64 w-64 mb-4 flex items-center justify-center">
          <img
          ...
          <tbody>
            {[1, 2, 3, 4, 5].map((item) => (
              <tr key={item} className="hover:bg-gray-50">
                <td className="border px-4 py-2">Song Title {item}</td>
                <td className="border px-4 py-2">Artist Name</td>
                <td className="border px-4 py-2">3:30</td>
              </tr>
            ))}
          </tbody>
        </table>
